...
<div class="js-container container" style="top:0px !important;"></div>
  ...
  <div style="text-align:center;margin-top:30px;position:  fixed;width:100%;height:100%;top:10%;left:0px;font-size: xx-large;">
    ...
    <button class="submit-btn" type="submit" onclick="redirectNow();">Continue</button>
  </div>  
