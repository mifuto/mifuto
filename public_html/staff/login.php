...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Sign in to your staff account to start your session</p>
      ...
      <p class="mb-0">
        <a href="register.php" class="text-center">Register a new staff</a>
      </p>
    </div>
    <!-- /.login-card-body -->
  </div>
...
function getCity(selectId,val="",selState="") {
  ...
  function checkLogin(){
    ...
    data = { "function": 'User',"method": "checkProviderStaffLogin" , "email":email, "password":password  };
