        ...
        if(resp.status == 1){
            ...
            if(list.length > 0 ){
                ...
                tbl +='<br><div class="callout callout-danger">';
                  ...
                  tbl +='<p class="text-muted pt-2">There are currently no images uploaded.</p>';
                tbl +='</div>';
        ...
        if(resp.status == 1){
            ...
            if(list.length > 0 ){
                ...
                tbl +='</div>';
                  ...
                  tbl +='<p class="text-muted pt-2">There are currently no events available. </p>';
                tbl +='</div>';
