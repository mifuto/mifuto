  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Our listed companies</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                 ...
                 <!-- /.card -->
                    ...
                    <!--  <div class="card-body">-->
                        <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
                            ...
                            <li class="nav-item">
                              <button class="nav-link" role="tab" data-toggle="pill" aria-selected="false" href="#profile-edit" onclick="editCompanyDetails();">Edit</button>
                            </li>
                            
                              <li class="nav-item d-none" id="companyServicePtyMenu">
                              <button class="nav-link" role="tab" data-toggle="pill" aria-selected="false" href="#property-instructions" onclick="editPropertyInstructions();">Service/property</button>
                            </li>
                            
                             <li class="nav-item d-none" id="companyLogoMenu">
                              <button class="nav-link" role="tab" data-toggle="pill" aria-selected="false" href="#profile-logo" onclick="uploadLogo();">Logo</button>
                            </li>
                            
                             <li class="nav-item d-none" id="updatePhotographMenu">
                              <button class="nav-link" role="tab" data-toggle="pill" aria-selected="false" href="#profile-photographs" onclick="uploadPhotographs();">Photographs</button>
                            </li>
                            
                             <li class="nav-item d-none" id="updateAccountMenu">
                              <button class="nav-link" role="tab" data-toggle="pill" aria-selected="false" href="#profile-account" onclick="uploadAccount();">Bank account</button>
                            </li>
                            
                            <li class="nav-item d-none" id="updateTCMenu">
                              <button class="nav-link" role="tab" data-toggle="pill" aria-selected="false" href="#property-tac" onclick="editTermsAndConditions();">Terms & Conditions</button>
                            </li>
                            
                             <li class="nav-item d-none" id="updateDocumentsMenu">
                              <button class="nav-link" role="tab" data-toggle="pill" aria-selected="false" href="#property-documents" onclick="uploadDocuments();">Documents</button>
                            </li>
    ...
    successFn = function(resp)  {
        ...
        if(resp.status == 1){
            ...
            if(list.length > 0 ){
                ...
                tbl +='<div class="col-6">';
                tbl +='<h4 class=" text-muted">My companies</h4>';
                tbl +='</div>';
                
                tbl +='<div class="col-6 ">';
                 tbl +='<div align="right">';
                
                tbl +='<button type="button" class="btn btn-primary float-right" onclick="addNewCompany();"><i class="fas fa-plus"></i> Add company</button>';
                tbl +='</div>';
                tbl +='</div>';
                ...
                for (var i = 0; i < list.length; i++) {
                    ...
                    else if(list[i]['is_accept_company'] == 1 && list[i]['is_add_service'] == 0 ) tbl +='<div class="ribbon bg-success">Accepted</div>';
                    ...
                    if(list[i]['staff'] == '' || list[i]['staff'] == null) tbl +='<span class="text-muted text-sm">Machooos staff:  </span><span class="text-danger">Unassigned </span>';
                    else tbl +='<span class="text-muted text-sm">Machooos staff:  '+list[i]['staff']+' '+list[i]['staff_lastname']+' </span>';
                    
                    if(list[i]['machoose_user_phone'] == '' || list[i]['machoose_user_phone'] == null) tbl +='<span class="text-muted text-sm">Machooos staff: </span><span class="text-danger">Unassigned  </span>';
                    else tbl +='<span class="text-muted text-sm">Machooos staff:  + 91 '+list[i]['machoose_user_phone']+' </span>';
                    
                    
                    tbl +='<p class="text-muted text-sm">'+list[i]['short_name']+', '+list[i]['state']+', '+list[i]['city']+' </p>';
                    ...
                    tbl +='<a href="#" class="btn btn-sm bg-danger" onclick="deleteCompany(`'+list[i]['id']+'`);" ><i class="fas fa-trash"></i></a>';
                    if(list[i]['is_accept_company'] == 1) tbl +='<a href="#" class="btn btn-sm btn-primary" onclick="viewEditCompany(`'+list[i]['id']+'`);">View company</a>';
                    else tbl +='<a href="#" class="btn btn-sm btn-primary" onclick="viewEditCompany(`'+list[i]['id']+'`);"><i class="nav-icon fas fa-edit"></i> Update company</a>';
                    tbl +='</div>';
                    tbl +='</div>';
                    tbl +='</div>';
                    tbl +='</div>';
                ...
                //         tbl +='<h4 class="card-title text-danger">';
                //         tbl +='<strong>Company information is incomplete.</strong> ';
                //         tbl +='</h4>';
                //         tbl +='<br><p class="text-muted pt-2">Your company information is incomplete. Please update your company details. Once updated, it will undergo approval. Until approval is granted, you will be unable to add any services.</p>';
                //         tbl +='<button type="button" class="btn btn-primary" onclick="viewEditCompany(`'+list[i]['id']+'`);">Update company</button>';
                //         tbl +='</div>';
                //         tbl +='</div>';
                ...
                //         tbl +='<div>';
                //         if(list[i]['company_logo_url'] == '' || list[i]['company_logo_url'] == null) tbl +='<p class="text-danger">Logo</p>';
                //         else{
                ...
                //         tbl +='<b class="text-primary"><a href="'+list[i]['company_link']+'">'+list[i]['company_link']+'</a></b><br>';
                ...
                tbl +='<div class="callout callout-danger">';
                  tbl +='<h5 ><i class="fas fa-info"></i> You have no companies</h5>';
                  tbl +='<p class="text-muted pt-2">Currently, you do not have a registered company associated with your account. Kindly add your company details to proceed. Once your company is added, it will undergo approval. Until approval is granted, you will be unable to add any services.</p>';
                tbl +='<button type="button" class="btn btn-primary" onclick="addNewCompany();">Create company</button>';
                tbl +='</div>';
                ...
                // tbl +='<div class="pt-4">';
                // tbl +='<h4 class="card-title text-danger">';
                // tbl +='<strong>You have no companies.</strong>';
                // tbl +='</h4>';
                // tbl +='<br><p class="text-muted pt-2">Currently, you do not have a registered company associated with your account. Kindly add your company details to proceed. Once your company is added, it will undergo approval. Until approval is granted, you will be unable to add any services.</p>';
                // tbl +='<button type="button" class="btn btn-primary" onclick="addNewCompany();">Create company</button>';
                // tbl +='</div>';
 ...
 function getAllPhotographsList(ids){
     ...
     successFn = function(resp)  {
            ...
            if(resp.status == 1){
                ...
                disD +='<div class="card-body">';
                disD +='<h4 class="card-title text-primary">';
                disD +='<strong>Photographs Details</strong> ';
                disD +='</h4><br>';
                    ...
                    for(var i=0;i<images.length;i++){
                        ...
                        if(l != 1)disD += '<hr><br>';
                          ...
                          disD +='<div class="row"><div class="col-lg-3 col-md-4 label text-muted ">Name</div><div class="col-lg-9 col-md-8">'+name+' '+lastname+'</div></div>';
                            disD +='<div class="row"><div class="col-lg-3 col-md-4 label text-muted ">Email</div><div class="col-lg-9 col-md-8">'+email+'</div></div>';
                              disD +='<div class="row"><div class="col-lg-3 col-md-4 label text-muted ">Contact number</div><div class="col-lg-9 col-md-8">'+phone+'</div></div>';
