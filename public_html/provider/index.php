...
<div class="form-group">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Finished service</h3>
<div class="form-group">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">
                  ...
                  Recently complted service gallery
                </h3>
              ...
              <div class="card-footer clearfix">
                <button type="button" class="btn btn-primary float-right"><i class="fas fa-plus"></i> View All Gallery</button>
              </div>
            </div>
            <!-- /.card -->
          </section>
