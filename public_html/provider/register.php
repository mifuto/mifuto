...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Sign up to your provider account to start your session</p>
                    ...
                    <div class="div mb-3 " id="registerUserDiv">
                        ...
                        <div class="" >
                            <form id="uploadCompanyLogoForm" class="g-3 needs-validation" novalidate="">
                                    ...
                                    <div class="row mb-3">
                                        <label for="" class="col-12 col-form-label">Upload logo (maximum image size is 500KB)</label>
                                        <div class="col-12">
                                            <input type="file" class="form-control"  id="uploadLogoFiles" name="uploadLogoFiles[]" accept="image/*" >
                    
                                            <div class="invalid-feedback">
                                            Please upload logo (Maximum image size is 500KB)
                                            </div>
                                        </div>
                                    </div>
        ...
        $("#submitButton1").addClass("d-none");
         ...
         successFn = function(resp)  {
            ...
            if(resp.status == 1){
              ...
              window.location.href = '/provider/done.php';
