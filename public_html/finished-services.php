...
$ordersData = [];
 ...
 $sqlcart = "SELECT * FROM place_order_userservices WHERE user_id=".$user_id." and newpurchaseID !='' and service_status =4 order by inpEventDate asc";
                    ...
                    <section class="flat-header color-bg adm-header">
                        ...
                        <div class="container">
                            <div class="dasboard-wrap fl-wrap">
                                <div class="dasboard-breadcrumbs breadcrumbs"><a href="#">Home</a><a href="#">Bookings</a><span>Finished Services</span></div>
                                    ...
                                    <div class="dashboard-list-box fl-wrap">
                                     ...
                                     ?>
                                        ...
                                        <div class="dashboard-list">
                                                 ...
                                                 <div class="dashboard-message-text">
                                                     <h4 style="color:red;">Finished Services Unavailable </h4>
                                                     <p>Finished services are not available.  </p>
