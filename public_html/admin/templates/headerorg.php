...
if($isAdmin){
    ...
    $userPermissions = 'Dashboard,Online-Album,Signature-Album,Wedding-Films,Website,Career,Sales,User-management,Staff-management,Reports,System-settings,Enquiries,Cards,Service-Provider,Companies,Provider-management,Provider-staff';
}else{
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <?php if (in_array('Online-Album', explode(',', $userPermissions))) { ?>
        ...
        <li class="nav-item">
         ...
         <li class="nav-heading">Provider</li>
