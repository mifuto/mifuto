...
if ($_FILES) {
	...
	$chkSqlImg = "SELECT id FROM tbeeventalbum_folderfiles WHERE `file_name`='$chkImgName' AND `album_id`='$AlbumId' AND hide=0 ";
	...
	if(sizeof($chkSqlImgList) == 0){
       ...
       imagickImage($imagePath,3072, 60 );
        ...
        $qry1 = "INSERT INTO `tbeeventalbum_folderfiles`(`file_name`, `file_size`, `album_id`,`file_path`,`thumb_image_path`) VALUES ('$filename','$filesize','$AlbumId','$targetFilePathUrl','$thumbnailsFilePath')";
