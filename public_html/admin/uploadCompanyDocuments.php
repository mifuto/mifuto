...
if ($_FILES) {
	...
	$targetDir = "companyDocuments/";
	$targetFilePath = $targetDir .'file_'.time(). $filename;
   ...
   try {
    ...
    $sql6 = "UPDATE tblproviderusercompany SET `company_document_url` = '$targetFilePathUrl', `company_document_name`='$filename' WHERE `id` = '$userId' ";
