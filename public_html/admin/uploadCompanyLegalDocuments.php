...
if ($_FILES) {
	...
	$targetDir = "companyDocuments/company_".$userId."/";
   ...
   try {
    ...
    $qry1 = "INSERT INTO `tbelegaldocuments_folderfiles` (`user_id`, `file_path`,`file_name`) VALUES ('$userId','$targetFilePathUrl','$filename')";
